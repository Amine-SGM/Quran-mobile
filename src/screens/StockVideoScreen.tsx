...
return (
  <div className="stock-video-screen">
    ...
    {visibleVideos.length === 0 && !loading && query && (
...
function selectBestFile(video: StockVideoItem) {
  if (video.provider === "pexels") {
    return selectPexelsFile(video.videoFiles as PexelsVideo["videoFiles"], video.matchedResolution);
  }

  return selectPixabayFile(video.videoFiles as PixabayVideo["videoFiles"], video.matchedResolution);
}
